...
import { twoembedIframe } from './embeds/twoembedIframe';
import { vidsrcembedIframe } from './embeds/vidsrcembedIframe';
...
import { vidsrcembedScraper } from './sources/vidsrcembed';
